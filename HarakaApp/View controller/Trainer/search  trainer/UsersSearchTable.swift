...
class UsersSearchTable:UITableViewController, UISearchBarDelegate, UISearchResultsUpdating {
...
// SHOULD NOT SHOW THE LOGGEDIN USER
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        let vc = storyboard?.instantiateViewController(withIdentifier: "ShowUsers") as? OtherUserTable
         vc?.otherUser = u

...
class PresentedViewController: UIViewController {
    ...
    func injected() {
        ...
        btnConfirm.setTitle("اختيار", for: .normal)
        btnConfirm.backgroundColor = #colorLiteral(red: 0.4173190594, green: 0.5955227613, blue: 0.6585710645, alpha: 1)
        ...
        if let title = style.titleString {
            ...
            titleLabel.textColor = #colorLiteral(red: 0.4173190594, green: 0.5955227613, blue: 0.6585710645, alpha: 1)
